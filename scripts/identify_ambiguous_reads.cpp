...
int main(int argc, char** argv) {
  ...
  if (argc < 8) {
    cout << "USAGE: ./identify_ambiguous_reads RESTRICTION_SITE GENOME_DIGEST MAPQ BINSIZE HOMOLOGY_FILE READ_FILE READPAIR_OUT STAT_OUT\n";
    return 1;
  }
